...
const CreateJob = () => {
  ...
  const onSubmit = (data) => {
    // Convert selected skills array of objects to array of strings
    ...
    .then(result => {
      ...
      if (result.acknowledged === true) {
        ...
        reset();
        setSelectedOption(null); // Reset skills select as well
      } else {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              />
              {errors.jobTitle && <p className="text-red-600">Job Title is required</p>}
            </div>
            <div className="lg:w-1/2 w-full">
          ...
          <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <input
                ...
                className='create-job-input'
              />
              {errors.maxPrice && <p className="text-red-600">Maximum Salary is required</p>}
            </div>
          </div>
          ...
          <div className="create-job-flex">
            <div className="lg:w-1/2 w-full">
              ...
              {errors.salaryType && <p className="text-red-600">Salary Type is required</p>}
            </div>
            <div className="lg:w-1/2 w-full">
              ...
              <input
                ...
                className='create-job-input'
              />
              {errors.jobLocation && <p className="text-red-600">Job Location is required</p>}
            </div>
          </div>
          ...
          <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              {errors.experienceLevel && <p className="text-red-600">Experience Level is required</p>}
            </div>
          </div>
          ...
          <div className="create-job-flex">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              {errors.employmentType && <p className="text-red-600">Employment Type is required</p>}
            </div>
          </div>
          ...
          <div className="w-full">
            ...
            <textarea
              ...
              style={{ resize: 'none' }}
            />
            {errors.description && <p className="text-red-600">Job Description is required</p>}
          </div>
          ...
          <div className="w-full">
            ...
            <input
              ...
              className='create-job-input'
            />
            {errors.postedBy && <p className="text-red-600">Employee Email is required</p>}
          </div>
